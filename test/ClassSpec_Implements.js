describe("Class Implements", function() {
  ...
  //describe("Implements feature", function() {

    describe("Employee doesn't inherit from Person: the members of Person are copied on Employee", function() {
      it("should get the contructor property be equals to Employee (when instantiaced)", function () { 
        expect(employee.constructor === Employee).toBeTruthy();
      });
      ...
      it("should be not instantiated as instanceof Person", function() {
        expect(employee instanceof Person).toBeFalsy();
      });

      it("should gets the getAge method from Person", function() {
    ...
    describe("methods defined on both the sub and the super are jus overridden", function() {
      it("should be the same 'initiliaze' method on employee and Employee", function() {
        expect(employee.initialize === Employee.prototype.initialize).toBeTruthy();
      });
    });

    describe("methods defined only on sub or super are reached by prototypal chain", function() {
